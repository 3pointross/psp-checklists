...
function psp_checklist_frontend_assets() {
	...
	if( ( get_post_type() == 'psp_projects' ) && ( current_user_can( 'edit_psp_project' ) ) ) {

		wp_enqueue_script( 'psp-checklists-front', plugins_url() . '/panorama-checklists/assets/js/psp-checklist-front.js', array( 'jquery' ), '1.0', false );
		wp_enqueue_style( 'psp-checklists-front', plugins_url() . '/panorama-checklists/assets/css/psp-checklist-front.css', null, '1.0', false );
