jQuery(document).ready(function($) {
    ...
    $('body.post-type-psp_projects .field_key-field_527d5dfd2fa2d .add-row-end').click(function() {
    ...
    $('body.post-type-psp_projects #acf-phases div.repeater').children('ul').find('.add-row-end').click(function() {
